...
\title{SISMID Module 9\\Lab 1: EpiFire Tutorial}
...
EpiFire is implemented in \C++ using Qt4, and is available for Linux (as source code), Windows, and OS X.  Installation files can be downloaded from |sourceforge.net/projects/epifire/| and source code is available at |www.github.com/tjhladish/EpiFire/|.  
